...
import com.new_eklavya.commnad.UserCommand.UpdateValidation;
...
public class UserController {
	...
	@GetMapping("/{userId}")
	public String getById(@PathVariable String userId, Model model) {
		
		model.addAttribute("user", userService.fetchById(userId));
		return "my_course";
	}
